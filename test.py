...
parser.add_argument('--test_dir', type=str, default='./NTIRE2023_Test_Hazy/') #please check the path for hazy images
...
with torch.no_grad():
    ...
    for batch_idx, (hazy_up_left, hazy_up_middle, hazy_up_right, hazy_middle_left, hazy_middle_middle, hazy_middle_right, hazy_down_left, hazy_down_middle, hazy_down_right,name,clean) in enumerate(test_loader):
    ...
    with open("ntire23-40-.txt", 'a') as f:
      f.write("epoch:" + str(i) + "; avr_psnr:" + str(avr_psnr) + "; avr_ssim:"+ str(avr_ssim) +"; avr_rmse:"+ str(avr_rmse) + "\n")
